...
def _handler_factory(runtime: Any):
    ...
    class ControlPlaneHandler(BaseHTTPRequestHandler):
        ...
        def _send_security_headers(self) -> None:
            ...
            self.send_header("Content-Security-Policy", "default-src 'self'; style-src 'self' 'unsafe-inline'; script-src 'self' 'unsafe-inline' 'wasm-unsafe-eval'; connect-src 'self' ws: wss: http: https:;")

...
class ViewValidator:
    ...
    def validate_syntax(self, source_code: str) -> ViewValidationResult:
        ...
        if (
            "interface Props" in source_code
            and "Props" not in source_code.split("interface Props")[1].split("{")[0]
        ):
    ...
    def validate_with_tsc(
        self, source_code: str, filename: str = "View.tsx"
        ...
        try:
            with tempfile.TemporaryDirectory() as tmpdir:
                ...
                tsconfig_file.write_text(__import__("json").dumps(tsconfig), encoding="utf-8")

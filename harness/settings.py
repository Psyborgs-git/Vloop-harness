...
class HarnessSettings(BaseSettings):
    ...
    allowed_origins: str = Field(
        "http://localhost:9102,http://127.0.0.1:9102,http://localhost:9100,"
        "http://127.0.0.1:9100,http://localhost:1420,tauri://localhost",
    ...
    vector_store_backend: str = Field("sqlite-vec", alias="VECTOR_STORE_BACKEND")

...
export declare class EnvironmentConfig extends Message<EnvironmentConfig> {
  ...
  /**
   * Optional python virtual environment path
   *
   * @generated from field: string python_path = 7;
   */
  pythonPath: string;

  /**
   * Optional SSH private key (write-only / masked when returned)
   *
   * @generated from field: string ssh_key = 8;
   */
  sshKey: string;
